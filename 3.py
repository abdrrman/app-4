...
st.sidebar.markdown("Musk 2.0: Be Elon! is an app that allows you to experience what it's like to be Elon Musk. Explore his life, make decisions, and see the impact of your choices on his success and legacy.")


st.title('Musk 2.0: Be Elon!')
...
if not openai_api_key.startswith('sk-'):
    ...
    with st.spinner('DemoGPT is working on it. It takes less than 10 seconds...'):
        elon_response = elonMuskResponse(message)
else:
    elon_response = ""
